package dev.forcecodes.pawmance.ui.signin

import android.net.Uri
import dev.forcecodes.pawmance.data.auth.AuthenticatedUserInfoBasic
...
interface SignInViewModelDelegate {
   ...
   */
  val signInNavigationActionsImpl: Flow<SignInViewModelDelegateImpl.AdminAuthState>
}